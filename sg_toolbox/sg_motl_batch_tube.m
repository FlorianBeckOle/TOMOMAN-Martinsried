function sg_motl_batch_tube(tomolist_name,motl_name,radlist_name,metadata_type,binning,l_dist,c_dist,padding,subset_list)
%% sg_motl_batch_tube
...
% motl_name = 'allmotl_1/allmotl_1.star';
% radlist_name = 'allmotl_1/allmotl_1_rad.txt';
% metadata_type = 'tube';
% binning = 8;
% l_dist = 2;
% c_dist = 2;
...
for i = 1:n_tomos
    ...
    for j = 1:n_tubes
        ...
        temp_motl = sg_motl_generate_tube_function(cens(8:10,:),l_dist,c_dist,tube_rad(j,3));
