...
% References
refA_name = 'ref_A_8.mrc';
refB_name = 'ref_B_8.mrc';

% FSC mask
mask_name = '../masks/curved_mask.mrc';

% Volume parameters
symmetry = 'C1';      % Symmetry operator. 'C1' for no symmetry.
pixelsize = 1.66*2;     % In Angstroms

% Output name
ref_avg_name = 'filt_8.mrc';  % Name of output filtered reference. Set to 'none' for no averaging.
flip_density = 1;
...
% B-factor sharpening
bfactor = -100;     % Set to 0 for no sharpening.
