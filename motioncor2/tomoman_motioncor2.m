...
% %%%% DEBUG
% root_dir = '/hd1/wwan/mintu/VUKrios_Apr22/tomoman_test_mpi2/';
...
% Get dependencies
dep = tm_get_dependencies('linux');                 % Basic linux commands
dep = tm_get_dependencies('motioncor2',dep);        % MotionCor2
...
if par_proc
    ...
    % Split tomolist
    [tomolist,p.tomolist_name,par] = tm_split_tomolist(tomolist,p.tomolist_name,par);
    if isempty(tomolist)
        return
    end
