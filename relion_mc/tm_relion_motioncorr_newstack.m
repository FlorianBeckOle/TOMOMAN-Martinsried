...
for i = 1:n_stacks
    ...
    disp([p.name,'Running the Relion implementation of MotionCorr2 on EER stack ',tomo_str]);
...
%     num_stacks = 1;            
    ...
    header = sg_append_mrc_label(header,'TOMOMAN: Frames aligned with Relion''s implementation of MotionCorr2.');
